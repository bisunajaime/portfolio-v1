...
import flutter_sj from '../../assets/images/activities/flutter_sj1.png'
import flutter_forstarters from '../../assets/images/activities/flutter_forstarters.png'
    ...
    return (
        <Fade>
            <div className='activities_list'>
                ...
                <Activity title="Guest Speaker" description="Guest speaker at Flutter for Starters Webinar hosted by Developer Student Clubs." link="https://www.facebook.com/dsc.philippines/videos/1617848895036898" imgUrl={flutter_forstarters} />

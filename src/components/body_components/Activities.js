...
function ActivitiesList() {
    return (
        <div className='activities_list'>
            ...
            <Activity title="Flutter Study Jam" description="Taught students of DLS-CSB the basics of Flutter." />
            <Activity title="Flutter Study Jam 2" description={`Taught students how to create a QR Code Scanner with Flutter.`} />
        </div>
    )
}
